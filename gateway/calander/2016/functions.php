 ...
 */
require get_template_directory() . '/include/postlist.php'; 

// require get_template_directory() . '/include/designPattern.php';  
/**
 *  used for custom woocomerce add to cart operations
 */
require get_template_directory() . '/include/wooCommData.php';  